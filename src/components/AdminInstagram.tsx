              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-800">
                  {categoryFilteredSubmissions.length === 0 ? (
                    <tr>
                      <td colSpan={8} className="py-10 text-center text-slate-500 text-sm">কোনো ইনস্টাগ্রাম আইডি রেকর্ড পাওয়া যায়নি।</td>
                    </tr>
                  ) : (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10.5px] text-slate-400 mt-1">
                            মোট ইন্সটাগ্রাম আইডি সাবমিট করেছেন: <strong className="text-white">{group.total} টি</strong>
                          </p>
                        </div>
                      </div>
